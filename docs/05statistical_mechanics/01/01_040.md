...
$$
\begin{aligned}
S(n) &= k_B \log \left[ \frac{N!}{n!(N-n)!} \right] \\
&= k_B \left[ \log N! - \log n! - \log (N-n)! \right]
\end{aligned}
$$
...
$$
\finalanswer{S(n) \simeq k_B \left[ N \log N - n \log n - (N-n) \log (N-n) \right]}
$$
...
$$
\begin{aligned}
\frac{dS(n)}{dn} &= k_B \left[ - \log n - 1 + \log (N-n) + 1 \right] \\
&= k_B \log \left( \frac{N-n}{n} \right)
\end{aligned}
$$
...
$$
\begin{aligned}
S\left(\frac{N}{2}\right) &= Nk_B\log 2,\qquad \left.\frac{d^2S}{dn^2}\right|_{n=N/2} \\
&= -\frac{4k_B}{N}
\end{aligned}
$$
