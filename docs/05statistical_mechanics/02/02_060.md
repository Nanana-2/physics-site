...
(2) 同じ温度と圧力をもつ異なる2種類の理想気体を，容器を接続して混合する。このとき，(1)の式から導かれる混合エントロピー $\Delta S = S_{\mathrm{total}} - (S_1 + S_2)$ は正になる。一方，同種粒子からなる2つの気体に同じ計算を適用しても，巨視的な変化がないにもかかわらずエントロピーが増加する。この矛盾の名称を答えよ。
