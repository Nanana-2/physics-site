...
$$
\finalanswer{y(t) = v_0 t \sin\theta - \frac{1}{2} gt^2}
$$
...
$$
\finalanswer{y = x \tan\theta - \frac{g}{2 v_0^2 \cos^2\theta} x^2}
$$
...
$$
\finalanswer{t_1 = \frac{v_0 \sin\theta}{g}}
$$
...
$$
\begin{aligned}
y_{\text{max}} &= v_0 \left( \frac{v_0 \sin\theta}{g} \right) \sin\theta - \frac{1}{2} g \left( \frac{v_0 \sin\theta}{g} \right)^2 \\
&= \frac{v_0^2 \sin^2\theta}{g} - \frac{v_0^2 \sin^2\theta}{2g} \\
&= \finalanswer{\frac{v_0^2 \sin^2\theta}{2g}}
\end{aligned}
$$
...
$$
\finalanswer{t_2 = 2t_1 = \frac{2v_0 \sin\theta}{g}}
$$
...
$$
\begin{aligned}
x_{\text{max}} &= v_0 (t_2) \cos\theta \\
&= v_0 \left( \frac{2v_0 \sin\theta}{g} \right) \cos\theta \\
&= \frac{v_0^2 \cdot 2 \sin\theta \cos\theta}{g}
\end{aligned}
$$
...
$$
\finalanswer{x_{\text{max}} = \frac{v_0^2 \sin 2\theta}{g}}
$$
