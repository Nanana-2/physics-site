...
これらの単位ベクトルの時間微分 $\dfrac{d\boldsymbol{e}_r}{dt}$ および $\dfrac{d\boldsymbol{e}_\theta}{dt}$ を計算し， $\boldsymbol{e}_r, \boldsymbol{e}_\theta$ および角速度 $\dot{\theta} = \dfrac{d\theta}{dt}$ を用いて表せ。
...
$$
\begin{aligned}
\dfrac{d\boldsymbol{e}_r}{dt}
&= \dfrac{d\boldsymbol{e}_r}{d\theta}\dfrac{d\theta}{dt} \\\\
...
$$
\finalanswer{\dfrac{d\boldsymbol{e}_r}{dt} = \dot{\theta} \boldsymbol{e}_\theta}
$$
...
$$
\begin{aligned}
\dfrac{d\boldsymbol{e}_\theta}{dt}
&= \dfrac{d\boldsymbol{e}_\theta}{d\theta}\dfrac{d\theta}{dt} \\\\
...
$$
\finalanswer{\dfrac{d\boldsymbol{e}_\theta}{dt} = -\dot{\theta} \boldsymbol{e}_r}
$$
...
&= \dfrac{dr}{dt} \boldsymbol{e}_r
+ r \dfrac{d\boldsymbol{e}_r}{dt}
\end{aligned}
$$

ここに (1) の結果である $\dfrac{d\boldsymbol{e}_r}{dt} = \dot{\theta} \boldsymbol{e}_\theta$ を代入し，時間微分をドット記号で表現します。
...
\begin{aligned}
\boldsymbol{a}
&= \dfrac{d\boldsymbol{v}}{dt} \\\\
&= \left(\ddot{r}\boldsymbol{e}_r
+\dot{r}\dfrac{d\boldsymbol{e}_r}{dt}\right)
+\left(\dot{r}\dot{\theta}\boldsymbol{e}_\theta
+r\ddot{\theta}\boldsymbol{e}_\theta
+r\dot{\theta}\dfrac{d\boldsymbol{e}_\theta}{dt}\right)
\end{aligned}
$$
