...
<figure class="problem-figure">
  <div class="problem-diagram problem-diagram--inclined">
    <img src="../../../assets/images/figures/mechanics/inclined-plane-friction.svg" alt="粗い斜面上の物体と座標軸">
    <span class="diagram-label diagram-label--inclined-m">\(m\)</span>
    <span class="diagram-label diagram-label--inclined-x">\(x\)</span>
    <span class="diagram-label diagram-label--inclined-y">\(y\)</span>
    <span class="diagram-label diagram-label--inclined-theta">\(\theta\)</span>
  </div>
</figure>
